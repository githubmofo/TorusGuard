...
v0.9.1 achieves **full Workspace Autonomy** and complete self-contained operation by introducing an autonomous Python bootstrapper, a bundled offline template payload, a root standalone installer, and a cryptographic integrity ledger.
...
Full architectural specification detailing:
