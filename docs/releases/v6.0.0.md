# Release Notes: TorusGuard v6.0.0 — Governed Remediation & Targeted Recheck System
...
TorusGuard **v6.0.0** evolves TorusGuard from a static detection and auditing tool into a **governed security remediation and targeted recheck system**. 

While traditional security scanners generate fragmented lists of individual line-level alerts, TorusGuard v6 introduces:
