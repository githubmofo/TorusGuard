...
| **FastAPI High-Performance API** | `examples/python/fastapi-vuln` | `4` | `2` | 🟢 Verified Fixed / Actionable |
| **Flask Content Management App** | `examples/python/flask-vuln` | `4` | `2` | 🟢 Verified Fixed / Actionable |
| **SQLAlchemy Multi-Tenant Data Layer** | `examples/python/sqlalchemy-vuln` | `4` | `2` | 🟢 Verified Fixed / Actionable |
