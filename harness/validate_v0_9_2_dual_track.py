...
def test_dual_track_architecture():
    ...
    assert pkg_data.get("version") in ("0.9.2", "0.9.3", "0.9.4", "0.9.5", "1.0.0", "1.1.0", "1.2.0", "1.3.0"), f"Invalid version: {pkg_data.get('version')}"
    ...
    assert any(v in res_status.stdout for v in ("0.9.2", "0.9.3", "0.9.4", "0.9.5", "1.0.0", "1.1.0", "1.2.0", "1.3.0"))
