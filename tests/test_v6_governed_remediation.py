"""
TorusGuard v6 Governed Remediation Test Suite
Tests:
...
8. End-to-End v6 Governed Remediation Workflow Execution
"""
...
class TestTorusGuardV6(unittest.TestCase):

    def setUp(self):
        self.test_dir = Path(tempfile.mkdtemp(prefix="torusguard-v6-test-"))
    ...
    def test_run_folder_creation_and_manifest(self):
        ...
        with open(run_mgr.manifest_file, "r", encoding="utf-8") as f:
            data = json.load(f)
        self.assertEqual(data["version"], "v6.0.0")
