# TorusGuard v6 Execution Summary — `container_security`
...
|---|---|---|---:|---:|---|---|
| `cluster-secrets` | Hardcoded Secrets & Sensitive Environment Configuration Exposure | `TG-SEC-001` | 1 | 1 | `Dockerfile` | High |
