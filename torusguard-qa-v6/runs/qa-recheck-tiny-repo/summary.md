...
|---|---|---|---:|---:|---|
| `cluster-platform-003` | Systemic Production Debug Mode Enabled Issues | `TG-PLATFORM-003` | 1 | 1 | Medium |
| `cluster-secrets` | Hardcoded Secrets & Sensitive Environment Configuration Exposure | `TG-SEC-001` | 1 | 1 | Critical |
