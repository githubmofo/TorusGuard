# TorusGuard v6 Execution Summary — `ci_pipeline`
...
|---|---|---|---:|---:|---|---|
| `cluster-supply-001` | Systemic Unpinned GitHub Action and Unbounded Permissions Issues | `TG-SUPPLY-001` | 1 | 1 | `.github/workflows` | Medium |
